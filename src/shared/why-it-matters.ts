...
export const WHY_IT_MATTERS: Record<string, string> = {
  ...
  'link-name': "People using a screen reader hear a link with no text and can't tell where it goes.",
  ...
  'no-autoplay-audio': 'Sound that plays automatically drowns out screen readers and startles people.',
  ...
  'th-has-data-cells': "This table's headers don't line up with its data, confusing screen reader users.",
  ...
  'nested-interactive': 'Controls placed inside other controls trap keyboard and screen reader users.',
  ...
  'performance-cls': 'The page jumps around as it loads, making people tap or click the wrong thing.',
  ...
  'performance-long-task': "A long-running script freezes the page, so taps and clicks don't register.",
  ...
  'performance-page-load-time': "The page takes a long time to fully load, testing people's patience.",
  ...
  'structured-data-missing': 'The page misses out on rich search results like ratings, prices, and FAQs.',

  // --- Security ---
  'headers-check-failed': "Security headers couldn't be checked, so the page's protections are unverified.",
  'https-not-enabled':
  ...
  'header-referrer-policy': 'Without this, the page can leak where your visitors came from to other sites.',
  'header-permissions-policy':
    'Without this, embedded content can quietly access powerful features like camera or location.',

  // --- Best Practices ---
  'library-scan-scope': 'Only some libraries could be checked, so hidden vulnerable dependencies may remain.',
  ...
  'image-aspect-ratio': "Stretched or squashed images look unprofessional and distort what's shown.",
  'doctype-missing': 'Without a doctype, browsers may render the page in an old, unpredictable mode.',
  'doctype-invalid': 'An incorrect doctype can make browsers render the page in an unpredictable mode.',
  'charset-missing': 'Without a declared character set, text and symbols may show as garbled characters.',
  'lang-missing': 'Without a language set, screen readers and translation tools may handle the text wrong.',
  ...
  'meta-refresh': 'Auto-refreshing or redirecting the page can disorient people and lose their place.',
  'passive-listeners': 'Non-passive scroll handlers make scrolling feel janky, especially on touchscreens.',
  'geolocation-on-load': 'Asking for location the moment someone arrives feels invasive and gets denied.',

  // --- PWA ---
  'manifest-missing': "Without an app manifest, people can't install this site as an app on their device.",
  'manifest-name-missing': 'The installed app would show no name, confusing people on their home screen.',
  'manifest-short-name-missing': 'The app icon would show no short label under it on the home screen.',
  'manifest-start-url-missing': 'Launching the installed app may open the wrong page or fail to open.',
  'manifest-display-missing':
    'The installed app opens in a browser tab instead of feeling like a real app.',
  'manifest-theme-color-missing': "The app's toolbar shows a default color instead of matching your brand.",
  ...
  'service-worker-not-supported': "This browser can't support the offline features that make a site app-like.",
  ...
  'pwa-viewport-missing': "Without a viewport tag, the installed app won't scale correctly on phones.",
